...
public final class ShareConstant {
    public static final String FILENAME = "android";
    //in pairs
    ...
    public static final String cfz_POWER_CENTER = "com.cfz.powercenter";
    public static final String cfz_SAFE_CENTER = "com.cfz.safecenter";
    public static final String cfz_SAFE_CENTER_WW = "com.cfz.safecenter.ww";
    public static final String ANDROID_BROWER_PKG = "com.android.browser";
    public static final String cfz_THEME_PKG = "com.cfz.themecenter";
    ...
    public static final String[] BU_POWER_SAVING = {"com.cfz.powersaving", "com.android.savepower", "com.battery.view"};
