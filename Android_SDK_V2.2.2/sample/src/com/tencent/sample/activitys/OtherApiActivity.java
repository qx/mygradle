...
public class OtherApiActivity extends BaseActivity implements OnClickListener {
			...
			builder.setPositiveButton("确定",
					new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface dialog, int which) {
							...
							Weibo weibo = new Weibo(OtherApiActivity.this, MainActivity.mQQAuth.getQQToken());
	...
	private void onClickCheckLogin() {
		...
		MainActivity.mQQAuth.login(this, SCOPE, listener);
	}
				...
				if (ret == 0) {
					...
					if (mNeedReAuth) {
						Runnable r = new Runnable() {
							public void run() {
								MainActivity.mQQAuth.reAuth(activity,
